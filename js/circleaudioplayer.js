...
var DEFAULTS = {
	borderColor: "#AB9595",
	playedColor: "#ffffff",
	backgroundColor: "rgba(179,50,50,.2)",
	iconColor: "#ffffff",
	borderWidth: 2,
	size: 48,
...
CircleAudioPlayer.prototype = {
	...
	play: function () {
		this.audio.play();
		document.getElementById("playercima").style.display = 'none';
	},
	pause: function () {
		this.audio.pause();
		document.getElementById("playercima").style.display = 'block';
...
var cap = new CircleAudioPlayer({
	audio: 'https://stm6.conectastreaming.com:10146/stream',
  size: 120,
  borderWidth: 4
});
